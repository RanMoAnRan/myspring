...
/**
 * @Description //TODO 使用注解代替xml的bean装配 测试
 * @Date 16:08 2019/5/18
 *
 **/
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {"classpath:applicationContext2.xml"})//加载配置类或者xml配置文件
//用注解代替@Before中的内容
public class AccountDaoImpl2Test {
   ...
   /* @Before
    public void setUp() throws Exception {
        //加载配置文件初始化容器
        ApplicationContext applicationContext = ApplicationContextUtil.getApplicationContext("applicationContext2.xml");
